...
- [Blog Post - Accuracy Test](https://github.com/pervin0527/pervinco/blob/master/source/2.image_classification/model_test.py) - Test data can be evaluated faster in the form of tf.data.
