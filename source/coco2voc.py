...
input_path = '/data/backup/pervinco_2020/datasets/COCO2017/annotations'
output_path = '/data/backup/pervinco_2020/datasets/COCO2017'
src_base = os.path.join(input_path)
dst_base = os.path.join(output_path)
...
def base_dict(filename, width, height, depth=3):
    return {
        "annotation": {
            ...
            "folder": "COCO2017", "segmented": "0", "owner": {"name": "unknown"},
            "source": {'database': "The COCO 2017 database", 'annotation': "COCO2017", "image": "unknown"},
