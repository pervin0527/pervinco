...
train_data = object_detector.DataLoader.from_pascal_voc('/data/Datasets/Seeds/DMC/set8/images', '/data/Datasets/Seeds/DMC/set8/annotations', label_map)
...
model_file_name = 'efdet_dmc_d0_set8'
