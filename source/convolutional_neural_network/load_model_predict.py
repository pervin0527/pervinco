...
'''
model.load_weights('/home/barcelona/pervinco/model/20191204-120902.h5')

eval_dir = glob.glob('/home/barcelona/pervinco/datasets/cats_and_dogs_filtered/validation/cats/*.jpg')
# print(eval_dir)
