...
if __name__ == '__main__':
    ...
    file_98ps_train = f'{root_dir}/WFLW_annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_train.txt'
    fw_path_train = f'/{root_dir}/annotations/list_68pt_rect_attr_train_test/list_68pt_rect_attr_train.txt'
    file_98ps_test = f'/{root_dir}/WFLW_annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_test.txt'
