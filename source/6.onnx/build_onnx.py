...
def get_model():
    with strategy.scope():
        base_model = efn.EfficientNetB0(input_shape=(IMG_SIZE, IMG_SIZE, 3),
...
if __name__ == "__main__":
    ...
    SAVED_PATH = f'/home/ubuntu/pervinco/model/{DATASET_NAME}'
    ...
    keras2onnx.save_model(onnx_model, f'{SAVED_PATH}/{LOG_TIME}/main_model.onnx')
