...
def visualize(display_list):
    if not os.path.isdir("./on_train_exp1/batch"):
        os.makedirs("./on_train_exp1/batch")
    ...
    plt.savefig(f"./on_train_exp1/batch/sample_{idx}.png")
    # plt.show()
    plt.close()
...
def plot_samples_matplotlib(display_list, idx, figsize=(5, 3)):
    if not os.path.isdir("./on_train_exp1/epoch"):
        os.makedirs("./on_train_exp1/epoch")
    ...
    plt.savefig(f"./on_train_exp1/epoch/result_{idx}.png")
    # plt.show()
    plt.close()
