## ✈[Image Classification](https://github.com/pervin0527/pervinco/blob/master/docs/image_classification.md)
   ...
   - [Source Code - Training with Augmentation(include CutMix, MixUp) EfficientNet tf2](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_EfficientNet_ver2.py)
   ...
   - [Blog Post - Accuracy Test](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_model_test.py) - Test data can be evaluated faster in the form of tf.data.
   - [Source Code - Multi GPU Training](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_Multi_gpu_training.py)
   ...
   - [Source Code - training + tf.data](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_multi_label_classification.py)
   - [Source Code - Accuracy Test](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_multi_label_predict.py)
   ...
   - [Source Code](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/landmark_classification/k_fold_train.py)
   ...
   - [Source Code](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_EfficientNet_ver2.py)

      augmentation(using albumentations) + cutmix + mixup
      
         python3 tf2_Efficient_Net_ver2.py --input_dataset=/path/ --do_cutmix=True

   - [Source Code](https://github.com/pervin0527/pervinco/blob/master/source/1.image_classification/tf2_cut_mix_training.py)
