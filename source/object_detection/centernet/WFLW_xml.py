...
def write_process(data_dict, save_dir, is_train):
    if is_train:
...
if __name__ == "__main__":
    ...
    save_dir = f"{root_dir}/CUSTOM_XML"
    classes = ["face"]
    ...
    write_process(train_data, save_dir, True)

    test_data = refine_data(test_txt)
    write_process(test_data, save_dir, False)