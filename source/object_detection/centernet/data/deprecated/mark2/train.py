...
if __name__ == "__main__":
    ...
    with strategy.scope():
        model, prediction_model = centernet(input_shape=input_shape, num_classes=len(classes), backbone=backbone, max_detections=max_detections, mode="train") ## output shape : topk_x1, topk_y1, topk_x2, topk_y2, scores, class_ids
