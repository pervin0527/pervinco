...
model_path = '/home/barcelona/tensorflow/models/research/object_detection/jun/ssd_mobilenet_v2_fpnlite_320x320_coco17_tpu-8/exported_gp'
model_name = 'custom'
label_path = '/home/barcelona/tensorflow/examples/lite/examples/object_detection/android/app/src/main/assets/labelmap.txt'
...
export_model_path = f'{model_path}/{model_name}_meta.tflite'

# Copies model_file to export_path.
tf.io.gfile.copy(f"{model_path}/{model_name}.tflite", export_model_path, overwrite=True)
...
input_normalization.options.mean = [127.0]
input_normalization.options.std = [128.0]
