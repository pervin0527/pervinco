...
def get_model():
    base_model = tf.keras.applications.EfficientNetB6(input_shape=(IMG_HEIGHT, IMG_WIDTH, 3),
...
model_name = 'Efficientnet-B6 K-fold'
...
for train_idx, valid_idx in skf.split(images, labels):
    ...
    print('------------------------------------------------------------------------')
    print(f'Training for fold ' + str(fold_no))
