...
if __name__ == "__main__":
    ...
    CUSTOM_DS_PATH = '/data/tf_workspace/test_code/custom_mnist'
    TRAIN_DS_PATH = '/data/tf_workspace/datasets/dirty_mnist_2/dirty_mnist_2nd'

    CUSTOM_CSV_PATH = '/data/tf_workspace/test_code/custom_mnist.csv'
    CUSTOM_DF = pd.read_csv(CUSTOM_CSV_PATH)

    TRAIN_CSV_PATH = '/data/tf_workspace/datasets/dirty_mnist_2/custom_split/train-kfold-0.csv'
    TRAIN_DF = pd.read_csv(TRAIN_CSV_PATH)

    VALID_CSV_PATH = '/data/tf_workspace/datasets/dirty_mnist_2/custom_split/valid-kfold-0.csv'
