...
def get_model():
    with strategy.scope():
        ...
        dp1 = tf.keras.layers.Dropout(0.5)(avg)
        dense1 = tf.keras.layers.Dense(1024, activation='relu')(dp1)
        dp2 = tf.keras.layers.Dropout(0.5)(dense1)
        output = tf.keras.layers.Dense(26, activation="sigmoid")(dp2)
